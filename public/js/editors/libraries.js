var libraries = [
  ...
  },
  {
    'url': [
      ...
      'https:/s/tackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css'
    ],
    'label': 'Bootstrap ',
    'group': 'Bootstrap'
  },
...
var libraries = [
  ...
  {
    'url': jsbin.static + '/offline/code.jquery.com/jquery-3.3.1.js',
    'label': 'jQuery 3.3.1',
    'group': 'jQuery'
  },
  {
    'url': jsbin.static + '/offline/code.jquery.com/jquery-2.2.4.js',
    'label': 'jQuery 2.2.4',
    'group': 'jQuery'
  },
  {
    'url': jsbin.static + '/offline/code.jquery.com/jquery-1.12.4.js',
    'label': 'jQuery 1.12.4',
    'group': 'jQuery'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css',
      jsbin.static + '/offline/code.jquery.com/jquery-3.1.0.js',
      jsbin.static + '/offline/code.jquery.com/ui/1.12.1/jquery-ui.js'
    ],
    'label': 'jQuery UI 1.12.1',
    'group': 'jQuery UI'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css',
      jsbin.static + '/offline/code.jquery.com/jquery-1.12.4.js',
      jsbin.static + '/offline/code.jquery.com/ui/1.11.4/jquery-ui.js'
    ],
    'label': 'jQuery UI 1.11.4',
    'group': 'jQuery UI'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.css',
      jsbin.static + '/offline/code.jquery.com/jquery-1.11.3.js',
      jsbin.static + '/offline/code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.js'
    ],
    'label': 'jQuery Mobile 1.4.2',
    'group': 'jQuery Mobile'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/jquery-3.3.1.slim.min.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js',
      jsbin.static + '/offline/stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js',
      jsbin.static + '/offline/stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css'
    ],
    'label': 'Bootstrap ',
    'group': 'Bootstrap'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/jquery.min.js',
      jsbin.static + '/offline/maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css',
      jsbin.static + '/offline/maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js'
    ],
    'label': 'Bootstrap 3.3.6',
    'group': 'Bootstrap'
  },
  // {
  //   'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/prototype/1/prototype.js',
  //   'label': 'Prototype latest',
  //   'group': 'Prototype'
  // },
  // {
  //   'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/prototype/1.7/prototype.js',
  //   'label': 'Prototype 1.7.1',
  //   'group': 'Prototype'
  // },
  // {
  //   'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/prototype/1.6.1.0/prototype.js',
  //   'label': 'Prototype 1.6.1.0',
  //   'group': 'Prototype'
  // },
  // {
  //   'url': [
  //     jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/prototype/1/prototype.js',
  //     jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/scriptaculous/1/scriptaculous.js'
  //   ],
  //   'label': 'script.aculo.us latest',
  //   'group': 'Prototype'
  // },
  ...
  //   'url': [
  //     jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/prototype/1/prototype.js',
  //     jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/scriptaculous/1.8.3/scriptaculous.js'
  //   ],
  //   'label': 'script.aculo.us 1.8.3',
  //   'group': 'Prototype'
  // },
  ...
  // },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/mootools/1.5.0/mootools-yui-compressed.js',
    'label': 'MooTools 1.5.0',
    'group': 'MooTools'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/mootools/1.5.0/mootools-nocompat-yui-compressed.js',
    'label': 'MooTools 1.5.0 (without 1.2+ compatibility layer)',
    'group': 'MooTools'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/mootools/1.4.5/mootools-yui-compressed.js',
    'label': 'MooTools 1.4.5',
    'group': 'MooTools'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1/dojo/dojo.js',
    'label': 'Dojo latest',
    'group': 'Dojo'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.8/dojo/dojo.js',
    'label': 'Dojo 1.8.4',
    'group': 'Dojo'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.7/dojo/dojo.js',
    'label': 'Dojo 1.7.4',
    'group': 'Dojo'
  },
  {
    'url': [
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1/dijit/themes/claro/claro.css',
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1/dojo/dojo.js'
    ],
    'label': 'Dijit latest (Claro)',
    'group': 'Dojo'
  },
  {
    'url': [
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.8.4/dijit/themes/claro/claro.css',
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.8.4/dojo/dojo.js'
    ],
    'label': 'Dijit 1.8.4 (Claro)',
    'group': 'Dojo'
  },
  {
    'url': [
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.7.4/dijit/themes/claro/claro.css',
      jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/dojo/1.7.4/dojo/dojo.xd.js'
    ],
    'label': 'Dijit 1.7.4 (Claro)',
    'group': 'Dojo'
  },
  {
    'url': [
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2015.2.624/styles/kendo.common.min.css',
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2015.2.624/styles/kendo.silver.min.css',
      jsbin.static + '/offline/code.jquery.com/jquery-2.1.4.min.js',
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2015.2.624/js/kendo.ui.core.min.js'
    ],
    'label': 'Kendo UI Core 2015.2.624',
    'group': 'Kendo UI'
  },
  {
    'url': [
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2014.3.1411/styles/kendo.common.min.css',
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2014.3.1411/styles/kendo.default.min.css',
      jsbin.static + '/offline/code.jquery.com/jquery-1.9.1.min.js',
      jsbin.static + '/offline/da7xgjtj801h2.cloudfront.net/2014.3.1411/js/kendo.ui.core.min.js'
    ],
    'label': 'Kendo UI Core 2014.3.1411',
    'group': 'Kendo UI'
  },
  {
    'url' : [
      jsbin.static + '/offline/code.jquery.com/qunit/qunit-git.css',
      jsbin.static + '/offline/code.jquery.com/qunit/qunit-git.js'
    ],
    'label': 'QUnit',
    'group': 'Testing'
  },
  {
    'url' : [
    jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/require.js/2.1.14/require.js',
  ],
    'label': 'RequireJS',
    'group': 'AMD'
  },
  ...
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/zepto/1.0/zepto.min.js',
    'label': 'Zepto 1.0',
    'group': 'Zepto'
  },
  {
    'url':jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/angularjs/1.4.0/angular.min.js',
    'label': 'Angular 1.4.0 Stable',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/angularjs/1.4.0/angular.js',
    'label': 'Angular 1.4.0 Stable Uncompressed',
    'group': 'Angular'
  },
  {
    'url':jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js',
    'label': 'Angular 1.3.15 Stable',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.js',
    'label': 'Angular 1.3.15 Stable Uncompressed',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/ajax.googleapis.com/ajax/libs/angularjs/1.2.26/angular.min.js',
    'label': 'Angular 1.2.26 Legacy',
    'group': 'Angular'
  },
  {
    'url':jsbin.static + '/offline/rawgit.com/angular/bower-angular/master/angular.min.js',
    'label': 'Angular Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular/master/angular.js',
    'label': 'Angular Latest Uncompressed',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-animate/master/angular-animate.min.js',
    'label': 'Angular Animate Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-aria/master/angular-aria.min.js',
    'label': 'Angular Aria Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-messages/master/angular-messages.min.js',
    'label': 'Angular Messages Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-resource/master/angular-resource.min.js',
    'label': 'Angular Resource Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-route/master/angular-route.min.js',
    'label': 'Angular Route Latest',
    'group': 'Angular'
  },
  {
    'url': jsbin.static + '/offline/rawgit.com/angular/bower-angular-sanitize/master/angular-sanitize.min.js',
    'label': 'Angular Sanitize Latest',
    'group': 'Angular'
  },
  {
    'url': [jsbin.static + '/offline/fb.me/react-15.1.0.js', jsbin.static + '/offline/fb.me/react-dom-15.1.0.js'],
    'label': 'React + React DOM 15.1.0',
    'group': 'React'
  },
  {
    'url': [jsbin.static + '/offline/fb.me/react-with-addons-15.1.0.js', jsbin.static + '/offline/fb.me/react-dom-15.1.0.js'],
    'label': 'React with Add-Ons + React DOM 15.1.0',
    'group': 'React'
  },
  {
    'url': [jsbin.static + '/offline/fb.me/react-0.14.7.js', jsbin.static + '/offline/fb.me/react-dom-0.14.7.js'],
    'label': 'React + React DOM 0.14.7',
    'group': 'React'
  },
  {
    'url': [jsbin.static + '/offline/fb.me/react-with-addons-0.14.7.js', jsbin.static + '/offline/fb.me/react-dom-0.14.7.js'],
    'label': 'React with Add-Ons + React DOM 0.14.7',
    'group': 'React'
  },
  {
    'url': jsbin.static + '/offline/fb.me/react-0.13.3.js',
    'label': 'React 0.13.3',
    'group': 'React'
  },
  {
    'url': jsbin.static + '/offline/fb.me/react-with-addons-0.13.3.js',
    'label': 'React with Add-Ons 0.13.3',
    'group': 'React'
  },
  {
    'url': jsbin.static + '/offline/cdn.rawgit.com/zloirock/core-js/master/client/shim.min.js',
    'label': 'core-js',
    'group': 'shims'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/es5-shim/2.0.8/es5-shim.min.js',
    'label': 'ES5 shim 2.0.8',
    'group': 'shims'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/blissfuljs/1.0.2/bliss.min.js',
    'label': 'Bliss 1.0.2',
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/vue/1.0.16/vue.js',
    'label': 'Vue.js 1.0.16',
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/vue/2.0.3/vue.js',
    'label': 'Vue.js 2.0.3',
  },
  {
    'url': 'http://cdn.ractivejs.org/latest/ractive.js',
  ...
  {
    'url': [
      jsbin.static + '/offline/rawgithub.com/ai/autoprefixer-rails/master/vendor/autoprefixer.js'
    ],
    'label': 'Autoprefixer',
    'snippet': '<style type="unprocessed" id="AutoprefixerIn">%css%</style>\n<style id="AutoprefixerOut"></style>\n<script>\nAutoprefixerSettings = ""; //Specify here the browsers you want to target or leave empty\ndocument.getElementById("AutoprefixerOut").innerHTML = autoprefixer(AutoprefixerSettings || null).process(document.getElementById("AutoprefixerIn").innerHTML).css;\n</script>'
  },
  {
    'url': [
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js'
    ],
    'label': 'Backbone 1.1.2'
  },
  {
  ...
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/bonsai/0.4/bonsai.min.js',
    'label': 'Bonsai 0.4.latest'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/coffee-script/1.9.2/coffee-script.min.js',
    'label': 'CoffeeScript'
  },
  {
    'url': [
      jsbin.static + '/offline/code.jquery.com/jquery-1.11.1.min.js',
      jsbin.static + '/offline/builds.emberjs.com/tags/v1.13.5/ember-template-compiler.js',
      jsbin.static + '/offline/builds.emberjs.com/tags/v1.13.5/ember.debug.js'
    ],
    'label': 'Ember.js 1.13.5',
    'group': 'Ember'
  },
  {
    'url': jsbin.static + '/offline/builds.emberjs.com/tags/v1.13.6/ember-data.js',
    'label': 'Ember Data 1.13.6',
    'group': 'Ember'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/normalize/3.0.2/normalize.min.css',
    'label': 'Normalize.css 3.0.2'
  },
  {
    'url': [
      jsbin.static + '/offline/extjs.cachefly.net/ext-3.1.0/resources/css/ext-all.css',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/ext-core/3.1.0/ext-core.min.js'
    ],
    'label': 'ext-core 3.1.0'
  },
  {
    'url': [
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/css/normalize.min.css',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/css/foundation.min.css',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/vendor/modernizr.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/vendor/jquery.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/foundation.min.js'
    ],
    'label': 'Foundation 5.5.2'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/handlebars.js/1.0.0/handlebars.js',
    'label': 'Handlebars.js 1.0.0'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/knockout/3.3.0/knockout-min.js',
    'label': 'Knockout 3.3.0'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/less.js/1.3.3/less.min.js',
    'label': 'Less 1.3.3'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/lodash/4/lodash.min.js',
    'label': 'lodash 4.x',
    'group': 'Lodash'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/g/lodash@4(lodash.min.js+lodash.fp.min.js)',
    'label': 'lodash fp 4.x',
    'group': 'Lodash'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/lodash/3/lodash.min.js',
    'label': 'lodash 3.x',
    'group': 'Lodash'
  },
  {
  ...
  {
    'url': [
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/modernizr/2.6.2/modernizr.min.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/detectizr/1.5.0/detectizr.min.js'
    ],
    'label': 'Detectizr 1.5.0'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/prefixfree/1.0.7/prefixfree.min.js',
    'label': 'Prefixfree 1.0.7'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/processing.js/1.4.1/processing-api.min.js',
    'label': 'Processing 1.4.1'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/d3/4.2.3/d3.min.js',
    'label': 'D3 4.2.3',
    'group': 'D3'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/d3/3.5.6/d3.min.js',
    'label': 'D3 3.5.6',
    'group': 'D3'
  },
  {
    'url': jsbin.static + '/offline/code.highcharts.com/highcharts.js',
    'label': 'Highcharts latest'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js',
    'label': 'Rapha&euml;l 2.1.0'
  },
  {
    'url': [
      jsbin.static + '/offline/cdn.jsdelivr.net/chartist.js/latest/chartist.min.js',
      jsbin.static + '/offline/cdn.jsdelivr.net/chartist.js/latest/chartist.min.css'
    ],
    'label': 'Chartist.js latest'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/sammy.js/0.7.4/sammy.min.js',
    'label': 'Sammy 0.7.4'
  },
  {
    'url': [
  ...
  // {
  //   'url': jsbin.static + '/offline/remy.github.io/twitterlib/twitterlib.min.js',
  //   'label': 'TwitterLib'
  // },
  // {
  //   'url': jsbin.static + '/offline/jashkenas.github.io/underscore/underscore-min.js',
  //   'label': 'underscore'
  // },
  {
    'url':[
      jsbin.static + '/offline/code.jquery.com/jquery.min.js',
      jsbin.static + '/offline/canjs.com/release/2.0.3/can.jquery.min.js'
    ],
    'label': 'CanJS 2.0.3'
  },
  {
    'url':[
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/three.js/r82/three.min.js'
    ],
    'label': 'Three.js r82'
  },
  {
    'url':[
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/html5shiv/3.6.2/html5shiv.js'
    ],
    'label': 'HTML5 shiv'
  },
  {
    'url': [
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/polymer/0.3.3/platform.js',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/polymer/0.3.3/polymer.js'
    ],
    'label': 'Polymer 0.3.3'
  },
  {
    'url':[
      jsbin.static + '/offline/code.getmdl.io/1.2.1/material.indigo-pink.min.css',
      jsbin.static + '/offline/code.getmdl.io/1.2.1/material.min.js',
      jsbin.static + '/offline/fonts.googleapis.com/icon?family=Material+Icons'
      ],
    'label': 'Material Design Lite 1.2.1'
  },
  {
    'url': jsbin.static + '/offline/netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css',
    'label': 'Font Awesome 4.0.3'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/paper.js/0.9.12/paper.js',
    'label': 'Paper.js 0.9.12'
  },
  // {
  //   'url': {
  //     'url': jsbin.static + '/offline/openui5.hana.ondemand.com/resources/sap-ui-core.js',
  //     'id': 'sap-ui-bootstrap',
  //     'data-sap-ui-theme': 'sap_belize',
  //     'data-sap-ui-libs': 'sap.m'
  //   },
  ...
  // },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/gsap/1.11.7/TweenMax.min.js',
    'label': 'GSAP 1.11.7'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/phaser/2.0.5/phaser.min.js',
    'label': 'Phaser 2.0.5'
  },
  {
    'url': [
      jsbin.static + '/offline/vjs.zencdn.net/5.11/video-js.css',
      jsbin.static + '/offline/vjs.zencdn.net/5.11/video.js'
    ],
    'label': 'Video.js 5.11.x'
  },
  {
    'url': [
      jsbin.static + '/offline/aui-cdn.atlassian.com/aui-adg/5.7.0/js/aui.js',
      jsbin.static + '/offline/aui-cdn.atlassian.com/aui-adg/5.7.0/css/aui.css',
      jsbin.static + '/offline/aui-cdn.atlassian.com/aui-adg/5.7.0/js/aui-experimental.js',
      jsbin.static + '/offline/aui-cdn.atlassian.com/aui-adg/5.7.0/css/aui-experimental.css'
    ],
    'label': 'AUI (Atlassian UI) 5.7.0'
  },
  {
    'url': jsbin.static + '/offline/cdn.firebase.com/js/client/2.0.2/firebase.js',
    'label': 'Firebase 2.0.2'
  },
  {
    'url': [
      jsbin.static + '/offline/code.ionicframework.com/1.0.0-beta.13/js/ionic.bundle.min.js',
      jsbin.static + '/offline/code.ionicframework.com/1.0.0-beta.13/css/ionic.min.css'
    ],
    'label': 'Ionic 1.0.0-beta-13'
  },
  {
    'url': jsbin.static + '/offline/static.opentok.com/v2/js/opentok.min.js',
    'label': 'OpenTok v2.x (latest)'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/riot/2.6/riot+compiler.min.js',
    'label': 'Riot + Compiler (latest 2.6.x)'
  },
  {
    'url': [
      jsbin.static + '/offline/unpkg.com/blaze/dist/blaze.min.css',
      jsbin.static + '/offline/unpkg.com/blaze/dist/blaze.colors.min.css'
    ],
    'label': 'Blaze CSS (latest)'
  },
  {
    'url': jsbin.static + '/offline/unpkg.com/@reactivex/rxjs@5.0.3/dist/global/Rx.js',
    'label': 'RxJS 5.0.3',
    'group': 'RxJS'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.all.js',
    'label': 'rx.all 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.all.compat.js',
    'label': 'rx.all.compat 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.testing.js',
    'label': 'rx.testing 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': jsbin.static + '/offline/unpkg.com/rx-dom@7.0.3/dist/rx.dom.js',
    'label': 'rx.dom 7.0.3 (requires 4.x)',
    'group': 'RxJS'
  },
  // {
  ...
  // },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/immutable/3.7.3/immutable.min.js',
    'label': 'Immutable 3.7.3',
    'group': 'Data structures'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/mori/0.3.2/mori.js',
    'label': 'mori 0.3.2',
    'group': 'Data structures'
  },
  {
    'url': jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/ramda/0.22.1/ramda.min.js',
    'label': 'Ramda 0.22.1'
  },
  {
    'url': [
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.2/semantic.min.css',
      jsbin.static + '/offline/cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.2/semantic.min.js'
    ],
    'label': 'Semantic UI 2.2.2'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/pouchdb/latest/pouchdb.min.js',
    'label': 'PouchDB (latest)',
    'group': 'PouchDB'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/momentjs/2.14.1/moment-with-locales.min.js',
    'label': 'Moment 2.14.1',
    'group': 'Moment.js'
  },
  {
    'url': [
      jsbin.static + '/offline/cdn.jsdelivr.net/momentjs/2.14.1/moment-with-locales.min.js',
      jsbin.static + '/offline/cdn.jsdelivr.net/momentjs/2.14.1/locales.min.js'
    ],
    'label': 'Moment 2.14.1 (with locales)',
    'group': 'Moment.js'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/velocity/1.2.3/velocity.min.js',
    'label': 'Velocity JS 1.2.3',
    'group': 'Velocity'
  },
  {
    'url': jsbin.static + '/offline/cdn.jsdelivr.net/velocity/1.2.3/velocity.ui.min.js',
    'label': 'Velocity UI Pack 1.2.3',
    'group': 'Velocity'
  }
];
...
// this code is buggy, sigh
// if (config.offlinemode) {
//   var urlLib = require('url');
//   var path = require('path');
//   for (var i = 0; i < libraries.length; i++) {
//         var u = new URL(libraries[i].url);
//         libraries[i].localpath = jsbin.static + path.join( 'offline/',  u.host, u.pathname);
